...
import com.nell.nellstargram.navigation.model.DdayDTO
import kotlinx.android.synthetic.main.frgment_detail.view.*
import kotlinx.android.synthetic.main.frgment_grid.*
import kotlinx.android.synthetic.main.frgment_grid.view.*
...
class GridFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var viewGroup = LayoutInflater.from(activity).inflate(R.layout.frgment_grid, container, false)
